...
\begin{exer}\label{exer:duality:zeroinvect}\marginnote{\hyperref[soln:duality:zeroinvect]{See solution.}}
	Find the "initial" and "terminal" "object" in $\catVect{k}$.
\end{exer}
