...
\begin{exmp}[Ring of functions]\label{exmp:ringoffunc}
	%TODO: example for ring of functions.
\end{exmp}
...
\begin{exmps}%TODO: add visual example of reversing all arrows.
	\begin{enumerate}
...
\end{exmp}
%TODO: mono and epis in DGph, they are preserved by forgetful functors.
...
\end{exer}
\begin{exmp}\label{exmp:unions}%TODO: draw the diagrams like for the product and coproduct.
