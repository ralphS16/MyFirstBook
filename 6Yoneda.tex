...
\begin{proof}
	...
	($\Leftarrow$) First, we define $\projection_X$ and $\projection_Y$ to be the pair of "morphisms" corresponding to $\id_P$ under the "isomorphism@@CAT" $\Hom_{\mathbf{C}\cattimes \mathbf{C}}((P,P),(X,Y)) \isoCAT \Hom_{\mathbf{C}}(P,P)$. Given two "morphisms" $f: A \rightarrow X$ and $g: A \rightarrow Y$, the "isomorpshism@@CAT" 
