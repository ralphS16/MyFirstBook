...
\begin{exmps}[Concrete categories]\label{exmp:concreteCat}
	...
	\end{enumerate}
\end{exmps}
\begin{exer}\label{exer:catfunc:nrel}\marginnote{\hyperref[soln:catfunc:nrel]{See solution.}}
...
\begin{exer}[\NOW]\label{exer:catfunc:forgetfulcat}\marginnote{\hyperref[soln:catfunc:forgetfulcat]{See solution.}}
