...
%TODO: maybe monad for the poset is not satisfactory, talk about the lift monad that puts * at the bottom, what adjunctions does it come from ?
%TODO: Egil-Milner powerdomain monad on 2Rel
...
\begin{proof}
    ...
    \end{align*}
\end{proof}
\begin{exer}{soln:monads:adjmorphcommute}\label{exer:monads:adjmorphcommute}
...
\begin{exer}{soln:monads:comparisonkem}\label{exer:monads:comparisonkem}
...
\end{proof}
\begin{exer}{soln:monads:monadpointed}\label{exer:monads:monadpointed}
