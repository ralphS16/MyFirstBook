...
\end{defn}
This book is not the place to further study $2$"--categories@2cat", but we can say a few interesting things about them. There are notions of "morphisms" between "$2$--categories@2cat" (called $2$--functors) and morphisms between them (called $2$--natural transformations). The latter can be composed in three different ways (analog to "vertical@vertical composition" and "horizontal composition" for $2$--morphisms) and all possible compositions interact well together. In particular,\footnote{There several so-called coherence axioms that describe how all "compositions" interact, but we state only one of them.} there is a unique $2$--natural transformation that is the composition of all $2$--natural transformations in \eqref{diag:3comp} (there are multiple ways to obtain it, depending on what compositions you do in what order, but as in the "interchange identity", we require them to lead to the same $2$--natural transformation).
\begin{equation}\label{diag:3comp}%TODO: display Rrightarrows.
	% https://q.uiver.app/?q=
\begin{tikzcd}
	...
	\arrow[""{name=6, anchor=center, inner sep=0}, shift right=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=1, to=0]
	\arrow[""{name=7, anchor=center, inner sep=0}, shorten <=5pt, shorten >=5pt, Rightarrow, from=1, to=0]
	\arrow[""{name=8, anchor=center, inner sep=0}, shift right=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=2, to=3]
	\arrow[""{name=9, anchor=center, inner sep=0}, shorten <=5pt, shorten >=5pt, Rightarrow, from=2, to=3]
	\arrow[""{name=10, anchor=center, inner sep=0}, shift right=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=0, to=4]
	\arrow[""{name=11, anchor=center, inner sep=0}, shorten <=5pt, shorten >=5pt, Rightarrow, from=0, to=4]
	\arrow[""{name=12, anchor=center, inner sep=0}, shift right=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=3, to=5]
	\arrow[""{name=13, anchor=center, inner sep=0}, shorten <=5pt, shorten >=5pt, Rightarrow, from=3, to=5]
	\arrow[""{name=14, anchor=center, inner sep=0}, shift left=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=1, to=0]
	\arrow[""{name=15, anchor=center, inner sep=0}, shift left=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=0, to=4]
	\arrow[""{name=16, anchor=center, inner sep=0}, shift left=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=2, to=3]
	\arrow[""{name=17, anchor=center, inner sep=0}, shift left=5, shorten <=5pt, shorten >=5pt, Rightarrow, from=3, to=5]
	\arrow[shorten <=2pt, shorten >=2pt, from=6, to=7]
	\arrow[shorten <=2pt, shorten >=2pt, from=8, to=9]
	\arrow[shorten <=2pt, shorten >=2pt, from=10, to=11]
	\arrow[shorten <=2pt, shorten >=2pt, from=12, to=13]
	\arrow[shorten <=2pt, shorten >=2pt, from=7, to=14]
	\arrow[shorten <=2pt, shorten >=2pt, from=13, to=17]
	\arrow[shorten <=2pt, shorten >=2pt, from=9, to=16]
	\arrow[shorten <=2pt, shorten >=2pt, from=11, to=15]
\end{tikzcd}
\end{equation}
The "category" of $2$"--categories@2cat" with $2$--functors and $2$--natural transformations is now an instance of a $3$--category. The field of \textit{higher category theory} studies the generalizations of this to $n$--categories for any $n$ (even $n= \infty$!). However, most of higher category theory drops the \textit{strict} part of our definition of $2$--category because this condition is too strong. Very briefly, they allow the properties of "composition", namely "associativity" and "identities", to hold up to "natural isomorphisms".

There is a relatively simple way to define strict $n$--categories using \textit{enriched category theory}.\footnote{I hope you can indulge this continued digression. Higher categories and enriched categories are not an indispensible tool in mathematics as I believe categories are to some extent. Still, I think these two little teasers might inspire some readers.} The definition of a "locally small" "category" can be seen as entirely taking place in the "category" $\catSet$. From this point of view, a "locally small" "category" is a "collection" $\obj{\mathbf{C}}$ of "objects" equipped with
\begin{itemize}
...
We will detail a couple of \textit{easy} examples of "equivalences" and briefly metion a few \textit{harder} ones. Of course, all the "isomorphisms@@CAT" of "categories" we saw earlier are examples of "equivalences" where the "natural isomorphisms" are identities.
