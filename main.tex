...
%TODO: When I first tried to learn category theory, I realized there was a blatant gap in the market of category theory textbooks: there was no book made for me. For this reason, I had to look at multiple textbooks in order to learn at my own pace. This book conveniently fills this gap. More helpfully, this book is aimed at...
%TODO: ask about one-line explainations of cat theory , so that I can expand on them.
%TODO: category theory is just as hard to explain to someone that does not know about it as mathematics. (Imagine someone that has no idea what maths is, and how useful and efficient it has been) How would you convince someone that doesnt know what mathematics is to learn about it? Very hard to answer and same for category theory, I will try to give a 1% satisfactory answer and I hope this book accounts for the rest of the 99%. In this idea, category theory is not necessarily a language to do maths, we will do maths and use a lot of maths because that is the context of this book but it is not necessary, see PQP.
%TODO: because lots of proofs are straightforward unrolling of definitions, I did not spend same amount of time on the pedagogy of each proofs, some are dry and straight to the point while other are more fleshed out.
%TODO: put "see solution" in left margin.
%TODO: hookarrow to other notation. keep hook arrow for actual inclusions. Make them knowledge.
%TODO: explain what unroll means and how we will often use it. Make sure the knowledge unroll is consistently used.
%TODO: When I say, we leave you to check. It means at this point, I expect a post-rigorous check will convince you. Make some knowledge for this sentence.
%TODO: add small table of contents for each chapter in the margin.
